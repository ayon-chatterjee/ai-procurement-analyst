...
from ui import page_copilot, page_quotes, page_review, page_saved, state
...
state.PAGES.update({"copilot": copilot, "review": review, "quotes": quotes, "saved": saved})
...
st.navigation([copilot, review, quotes, saved], position="sidebar").run()
